...
{
	var RPC = window.USRPCConnection;
	//  TypeError: RPC.pc is undefined[Learn More]  RPCConnection.js:421:4
	//console.log( "window RPC=", window.USRPCConnection, "this RPC=", this );
	RPC.hidePreloader();
...
function showPreloader(){
	$('.video-container').append('<div class="container_preloader"><div class="loader-16 inner_preloader"></div></div>');
}

function hidePreloader(){
	$('.container_preloader').remove();
}
